...
echo "> DEPLOY_JAR 배포"    >> /home/ubuntu/app/deploy/deploy.log
nohup java -jar $DEPLOY_JAR >> /home/ubuntu/app/deploy/deploy.log 2>/home/ubuntu/app/deploy/deploy_err.log &